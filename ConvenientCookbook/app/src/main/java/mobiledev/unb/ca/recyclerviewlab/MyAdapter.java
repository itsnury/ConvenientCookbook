...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        final Course currentCourse = mDataset.get(position);

        // TODO 4
        //  Set the TextView in the ViewHolder (holder) to be the title for this Course
        holder.mTextView.setText(currentCourse.getTitle());
        ...
        holder.mTextView.setOnClickListener(v-> {
            ...
            intent.putExtra("name", currentCourse.getTitle());
            intent.putExtra("description", currentCourse.getDescription());
